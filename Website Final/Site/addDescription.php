...
<html lang="en">
<!--
	Class About: This is the form that the user's use to add the description 
	to the dictionary-->
    <head>
        <meta charset="UTF-8">
        <title>Ychwanegu disgrifiad</title>
        <link rel="stylesheet" type="text/css" href="css/style.css" />
        <script type="text/javascript" src="js/displayLog.js"></script>
        <script type="text/javascript" src="js/inputVar.js"></script>
    ...
    <body>
        ...
        <form action="descExecute.php" method="POST">
        Gair:*
        <br>
